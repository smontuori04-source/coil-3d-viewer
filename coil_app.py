...
st.set_page_config(page_title="3D Coil – Fixer Raum", layout="wide")
...
coil.append(go.Surface(
    ...
    showscale=False,
    lighting=dict(ambient=0.4, diffuse=0.8, specular=0.5, roughness=0.25)
))
coil.append(go.Surface(
...
fig.update_layout(
    ...
    dragmode="orbit"  # Nur drehen/zoomen, kein panning
)

# CSS für Vollbild und Sidebar
st.markdown("""
    <style>
